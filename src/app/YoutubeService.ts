...
export class YoutubeService {
  ...
  getChannels(channelName: string): Observable<any> {
    ...
    const url = "https://www.googleapis.com/youtube/v3/search?part=snippet&q=" + channelName + "&type=channel&key=AIzaSyA8JxOy_ccuIi1z1ZV8paGet7H9zZm7jEk" + "&maxResults=12"
